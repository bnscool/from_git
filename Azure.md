...
Check Create-vm.json present on Git
...
```
updateK8sManifests.sh is in Git
vote-pipeline.yaml is in Git
- ============================================================================
...
```
Day-22 create-function-app.sh is in Git
Day-23 backend.tf is in Git
Day-23 backend.tf is in Git
